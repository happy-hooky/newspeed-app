...
const LoginPage = () => {
  ...
  return (
    <View width="100%" height="100%" justifyContent="space-between" alignItems="flex-start">
      ...
      <View zIndex={1} width="100%" paddingHorizontal={28}>
        <View paddingVertical={40} width="100%">
        ...
        <View width="100%" alignItems="center" marginBottom={insets.bottom + 20}>
          <View
            width="100%"
            height={300}
            borderRadius={8}
      ...
      <LinearGradient
        ...
        colors={['rgba(228, 108, 124, 0.3)', 'rgba(237, 166, 37, 0.3)', 'rgba(211, 204, 24, 0.3)']}
      />
    </View>
  );
};
